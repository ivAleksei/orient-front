...
import { BlanksService } from 'src/apps/baseorient/_shared/providers/blanks.service';
...
export class BlanksPage implements OnInit {
  ...
  tableInfo: any = {
    ...
    ajax: {
      url: `${environment.API.orient}/server_side/blanks`,
    },
    actions: {
      buttons: [
